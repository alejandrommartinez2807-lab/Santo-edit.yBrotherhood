-- ============================================================
-- SETUP COMPLETO — Supabase de PRUEBA para la simulación
-- Proyecto destino: gnyvdlxlrjwbsdctincy
-- Contiene las 34 migraciones oficiales en orden (0001 → 0035)
-- + los buckets de storage (menu-images público, payment-proofs privado).
-- Pegar ENTERO en el SQL Editor de Supabase y ejecutar UNA vez.
-- (v2 — corrige la codificación de acentos de la primera versión)
-- ============================================================
