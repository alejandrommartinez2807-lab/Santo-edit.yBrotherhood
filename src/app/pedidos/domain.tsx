...
// Precarga desde lo que el cliente REPORTÓ (comprobantes activos): en MESA el
// checkout no pide método de pago, así que sin esto el modal abría en blanco
// aunque el cliente ya hubiera reportado su pago (2026-07-28). Espejo de la
// función del mismo nombre en caja/domain.
function derivePaymentPrefillFromProofs(proofs: PaymentProof[]): {
  amountReceivedUSD: string
  amountReceivedVES: string
  paymentMethodUSD: string
  paymentMethodVES: string
