    ...
    <main className="min-h-screen bg-[var(--brand-cream)] px-4 py-8 text-[var(--brand-ink-2)]">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black uppercase text-[var(--brand-ink-3)]">Canales / OTAs</h1>
        ...
        <div className="mt-6 rounded-2xl border-2 border-[var(--brand-primary)]/20 bg-white p-4">
          <p className="text-xs font-black uppercase text-[var(--brand-primary)]">Enlace iCal de disponibilidad</p>
          <div className="mt-2 flex flex-wrap items-center gap-2">
            ...
            <button onClick={copy} className="rounded-xl border-2 border-[var(--brand-primary)] bg-white px-3 py-2 text-xs font-black uppercase text-[var(--brand-primary)]">
              {copied ? "¡Copiado!" : "Copiar"}
            </button>
            <a href="/api/public/hotel/ical" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 rounded-xl border-2 border-[var(--brand-primary)] bg-white px-3 py-2 text-xs font-black uppercase text-[var(--brand-primary)]">
              <ExternalLink size={14} /> Ver
            </a>
          </div>
          <div className="mt-4 text-sm font-bold text-[var(--brand-ink-2)]/70">
            <p className="text-xs font-black uppercase text-[var(--brand-primary)]">Cómo usarlo</p>
