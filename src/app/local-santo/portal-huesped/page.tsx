    ...
    <main className="min-h-screen bg-[var(--brand-cream)] px-4 py-8 text-[var(--brand-ink-2)]">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-serif text-2xl text-[var(--brand-ink-3)] font-semibold">Portal del huésped</h1>
        ...
        <div className="mt-6 rounded-2xl border border-[var(--brand-primary)]/20 bg-white p-4">
          <p className="text-xs font-bold uppercase text-[var(--brand-primary)]">Enlace del portal</p>
          <div className="mt-2 flex flex-wrap items-center gap-2">
            ...
            <a href="/hotel/mi-reserva" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 rounded-xl border border-[var(--brand-primary)]/40 bg-white px-3 py-2 text-xs font-bold uppercase text-[var(--brand-primary)]">
