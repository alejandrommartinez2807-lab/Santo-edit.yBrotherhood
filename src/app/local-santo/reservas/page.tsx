    ...
    <main className="min-h-screen bg-[var(--brand-cream)] px-4 py-8 text-[var(--brand-ink-2)]">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black uppercase text-[var(--brand-ink-3)]">Reservas</h1>
        ...
        {denied ? (
          ...
          <>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <label className="flex items-center gap-2 rounded-xl border-2 border-[var(--brand-primary)]/25 bg-white px-4 py-2.5 font-bold">
            ...
            <div className="mt-4 grid gap-2 rounded-2xl border-2 border-[var(--brand-primary)]/20 bg-white p-4 sm:grid-cols-2">
              ...
              <label className="flex items-center gap-2 rounded-xl border-2 border-[var(--brand-primary)]/25 bg-white px-4 py-3 font-bold">
                <span className="text-xs font-black uppercase text-[var(--brand-primary)]">De</span>
                <input
                  type="time"
                  value={startTime}
              ...
              <label className="flex items-center gap-2 rounded-xl border-2 border-[var(--brand-primary)]/25 bg-white px-4 py-3 font-bold">
                <span className="text-xs font-black uppercase text-[var(--brand-primary)]">A</span>
                <input
                  type="time"
                  value={endTime}
              ...
              <input
                ...
                className="rounded-xl border-2 border-[var(--brand-primary)]/25 bg-white px-4 py-3 font-bold outline-none focus:border-[var(--brand-primary)] sm:col-span-2"
              />
              <button
                onClick={create}
                ...
                {reservations.map((reservation) => (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <span
                        className={`rounded-full border-2 px-3 py-1.5 text-xs font-black uppercase ${statusStyles[reservation.status]}`}
                      >
