...
const VISUAL_COLOR_PRESETS = [
  ...
  },
  {
    ...
    values: {
      themePrimaryColor: "#1f6feb",
      themeAccentColor: "#ffd23c",
      themeCreamColor: "#f4f7fb",
      productCardBackgroundColor: "#ffffff",
  ...
  },
  {
    ...
    values: {
      themePrimaryColor: "#16324f",
      themeAccentColor: "#f6c453",
      themeCreamColor: "#fff3dd",
      productCardBackgroundColor: "#0a1a30",
      productCardTextColor: "#f4f7fb",
