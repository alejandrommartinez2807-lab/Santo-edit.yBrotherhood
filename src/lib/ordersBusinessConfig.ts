...
export const DEFAULT_BUSINESS_CONFIG: BusinessConfig = {
  ...
  igtfEnabled: true,
  igtfRate: 3,
  // Paleta champán clara del hotel (los mismos tonos que :root de globals.css).
  // El dueño puede personalizarla desde Configuración; esto es lo de fábrica.
  ...
  publicInfoText: "Room service y restaurante del hotel: pide a tu habitación escaneando el QR o visítanos. Abre la ubicación en Google Maps o escríbenos por WhatsApp para coordinar tu pedido.",
  scheduleTitle: "Horario",
  scheduleLine1: "Room service: 7:00 a. m. a 11:00 p. m.",
  scheduleLine2: "Recepción: 24 horas",
  reviewsTitle: "Reseñas",
  reviewsText: "Después de tu pedido o tu estadía, puedes apoyar al hotel dejando tu reseña o compartiendo la página. Gracias por elegirnos.",
